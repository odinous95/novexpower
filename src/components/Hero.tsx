    ...
    return (
        ...
        >
            <div className="absolute left-0 top-0 bottom-0 -z-10 w-1/2 h-full">
                <div className="absolute inset-0 h-full w-full bg-[linear-gradient(to_left,#87ceeb12_1px,transparent_1px),linear-gradient(to_bottom,#87ceeb_1px,transparent_1px)] bg-[size:40px_30px] [mask-image:radial-gradient(ellipse_70%_100%_at_50%_100%,#000_60%,transparent_100%)]">
                </div>
            </div>
